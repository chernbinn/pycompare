...
## 赞助
<table align="center" cellpadding="0" cellspacing="0" border="0" style="border: none; border-collapse: collapse;">
  <tr>
    <!-- 第一张图片列，占 45% -->
    <td align="center" width="45%">
      <img src="./pics/微信1.png" width="55%" alt="图1">
    </td>
    <!-- 间隔列，占 10% -->
    <td width="10%">&nbsp;</td>
    <!-- 第二张图片列，占 45% -->
    <td align="center" width="45%">
      <img src="./pics/支付宝1.png" width="55%" alt="图2">
    </td>
  </tr>
</table>
